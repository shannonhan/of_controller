...
using ::vigil::openflow::Datapath_manager;
...
public:
    void init();
    Connection_manager(const std::list<std::string>& interfaces, ::boost::asio::io_service& io_service_, Datapath_manager&);
    Connection_manager* get_instance(const std::list<std::string>&, ::boost::asio::io_service&, Datapath_manager&);
