...
#include "openflow/netinet++/datapathid.hh"
#include "openflow/network_iarchive.hh"
#include "openflow/network_oarchive.hh"
...
{
public:
    Openflow_datapath(Datapath_manager&);
    ~Openflow_datapath();
...
private:
    ...
    Disposition handle_disconnect();
    Disposition handle_error_msg();
    Disposition handle_handshake(const v1::ofp_msg* msg);
